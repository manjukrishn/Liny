...
export default function Suggested(props) {
  ...
  const handleFollow = () => {
    ...
    return toBeUpdated
      .update({
        friends: firebase.firestore.FieldValue.arrayUnion(props.userId)
      })
      .then(function () {
  ...
  return (
    <Card className={classes.root} style={{ paddingBottom: "-2%" }}>
      <table>
        <tr>
          <td>
            <CardMedia
          ...
          <td style={{ marginLeft: "-5px", paddingRight: "15px" }}>
            <CardContent className="card-content-name-friends">
